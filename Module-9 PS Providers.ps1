...
Set-ItemProperty -Path HKLM:\SOFTWARE\Microsoft\BestPractices -name MaxScanReportsPerModel -value 21

get-itemproperty -path HKLM:\SOFTWARE\Microsoft\BestPractices
